...
import { Piece, PieceType, Position, Side, initialBoardState, samePostion } from "../../Constants";
import { bishopMove, getAllBishopMoves, getAllKingMoves, getAllKnightMoves, getAllPawnMoves, getAllRookMoves, kingMove, knightMove, pawnMove, rookMove } from "../../referee/rules";
...
export default function Referee() {
  ...
  function makeMove(piece: Piece, destination: Position) {
